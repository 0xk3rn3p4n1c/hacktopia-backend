...
export const TEAM_LISTED = "TEAM_LISTED";
export const TEAM_NOT_LISTED = "TEAM_NOT_LISTED";
export const TEAM_DETAILS_FETCHED = "TEAM_DETAILS_FETCHED";
export const TEAM_DETAILS_NOT_FETCHED = "TEAM_DETAILS_NOT_FETCHED";
export const JOIN_REQUEST_EXISTS = "JOIN_REQUEST_EXISTS";
export const JOIN_REQUEST_NOT_CREATED = "JOIN_REQUEST_NOT_CREATED";
export const JOIN_REQUEST_CREATED = "JOIN_REQUEST_CREATED";
...
export const JOIN_REQUEST_REJECTED = "JOIN_REQUEST_REJECTED";
export const JOIN_REQUEST_FETCHED = "JOIN_REQUEST_FETCHED";